...
player createDiarySubject ["BTSGaming","BTSGaming.NET Info"];
...
*/
player createDiaryRecord ["BTSGaming", 
 		[
 			"", 
 				"
 				Website: BTSGaming.NET<br/>
 				Teamspeak: TS.BTSGaming.NET<br/>
 				Want to Become an Officer? BTSGaming.NET Forums<br/>
 			"
 		]
 	];
	player createDiaryRecord["changelog",
		[
			"Official Change Log",
				"
					The official change log can be found on the BIS forums (search Altis Life RPG). </br>
 					Any addition changes by BTSGaming.NET can be found on our Github.
				"
		]
	];
		...
		[
			"Bannable Offenses", 
				...
				4. Being kicked 3 or more times.<br/>
 				5. Disobeying an Administrator. (If Admin is cop, rule does not apply.)<br/>
				"
		]
	];
...
// Police Section
	...
	player createDiaryRecord ["policerules",
		[
			"City Protocol", 
				...
				5. Martial law may only be called by an Administrator. Officers MUST contact officers before <br/>any shooting can occur. Unarmed civilians should not be killed, but detained and searched.<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Arresting and Ticketing",
				...
				2. You MUST tell the suspect why they are being arrested before you arrest them. They must be told before you take them to their point of jail.<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Weapons", 
				...
				2. Civilians may have a gun out when they are not in the town. However they should submit to a license search if confronted by an officer and should have the gun lowered (Press Ctrl Twice). Lethal Force is not allowed until shots have been fired. (aka. Don't Approach Until Gun is DOWN.)<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"Use of Non-Lethal Force",
				...
				2. Do not discharge your Taser unless you intend to incapacitate a civilian, randomly discharging your weapon will result in your suspension or removal from force.<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Raiding/Camping",
				...
				7. An area cannot be raided again for 15 minutes after a previous raid.<br/>
 				8. If the raid is a failure (All officers die), the 15 minute timer still applies to those officers. You may no return to the same raid.<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Teamspeak Rule",
				"
				1. All cops must be on Teamspeak 3 in a designated cop channel. Failure to be on Teamspeak during an admin check will result in your immediate dismissal from the server with a 30 minute ban which is not able to be appealed.<br/>
 				2. Join Teamspeak and the proper channel before joining the server. Failure to do so will be your mistake.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["illegalitems",
		[
			"Gang Rules",
				...
				4. To declare war on another gang, the leader must announce it in GLOBAL and all gang members of both gangs must be notified as well as the Administrators on Teamspeak. For a more long term gang war, a declaration should be made on the forums.<br/>
