...
_resGear = [_this,8,[],[[]]] call BIS_fnc_param;
...
switch (_side) do
{
	...
	case resistance:
	{
		...
		_resGear = [_resGear] call DB_fnc_mresArray;
		_query = format["UPDATE players SET name='%1', cash='%2', bankacc='%3', civ_licenses='%4', res_gear='%6', arrested='%7' WHERE playerid='%5'",
		_name,_money,_bank,_licenses,_uid,_resGear,_misc];
	};
};
