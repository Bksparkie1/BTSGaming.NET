...
*/
private["_unit","_side","_uid","_money","_bank","_uid","_misc","_licenses","_civGear","_name","_resGear"];
...
_resGear = [_this,9,[],[[]]] call BIS_fnc_param;
...
switch (_side) do
{
	...
	case resistance: {_misc = [_this,6,false,[false]] call BIS_fnc_param;};
};

[[_uid,_name,_side,_money,_bank,_licenses,_misc,_civGear,_resGear]] call DB_fnc_addQueue;